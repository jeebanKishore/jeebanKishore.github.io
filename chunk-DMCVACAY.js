...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},Qp=e=>{pu(e.inputs),e.compute(cu(e.inputs))}}),hu,fe,Zp,Xp,Yp,Jp,ec,tc,rc,ic,ac,fu,nc,sc,oc,uc,nr,lc,Dr,dc,pc,cc,hc,fc,mc,gc,yc,_c,wc,$c,bc,vc,xc,Sc,kc,Ri,Tc,ga,ya,Cc,Ic,Ec,mu,gu,zc,qa=q(()=>{"use strict";te(),se(),be(),ue(),hu=(e,t,i,r,n,o,s)=>{let l=Math.ceil(t/4),d="";typeof n=="string"?d=`${n}(a)`:d=n("a");let c=N("inputData",i,[l],4),g=K("outputData",r,[l],4),m=[{name:"vec_size",type:"u32"}];return s&&m.push(...s),`
...
`,gu=e=>`quick_gelu_impl(${e})`,zc=(e,t)=>{let i=ze(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"QuickGelu",gu,mu(i,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),yu,_u,Ac,fy=q(()=>{"use strict";se(),ue(),qa(),yu=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},_u=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let i=N("input",e[0].dataType,e[0].dims,4),r=N("bias",e[0].dataType,[e[0].dims[2]],4),n=K("output",e[0].dataType,t,4),o=O.size(t)/4,s=Te(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:l=>`
  ...
  ${l.mainStart()}
    ...
    ${n.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${v}
      }`},$u=(e,t,i,r,n,o,s=i.dataType)=>{let l=i.dims.map(b=>Number(b)??1),d=r.dims.map(b=>Number(b)??1),c=!O.areEqual(l,d),g=l,m=O.size(l),y=!1,w=!1,_=[c];if(c){let b=Wt.calcShape(l,d,!1);if(!b)throw new Error("Can't perform binary op on the given tensors");g=b.slice(),m=O.size(g);let S=O.size(l)===1,v=O.size(d)===1,$=l.length>0&&l[l.length-1]%4===0,k=d.length>0&&d[d.length-1]%4===0;_.push(S),_.push(v),_.push($),_.push(k);let C=1;for(let I=1;I<g.length;I++){let E=l[l.length-I],A=d[d.length-I];if(E===A)C*=E;else break}C%4===0?(w=!0,y=!0):(S||v||$||k)&&(y=!0)}else y=!0;return _.push(y),{name:e,shaderCache:{hint:t+_.map(b=>b.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:b=>wu(b,l,d,g,y,c,w,n,i.dataType,r.dataType,s,o),getRunData:()=>({outputs:[{dims:g,dataType:s}],dispatchGroup:{x:Math.ceil(m/64/4)},programUniforms:[{type:12,data:Math.ceil(O.size(g)/4)},...Z(l,d,g)]})}},Ke=(e,t,i,r,n,o)=>{e.compute($u(t,n??"",e.inputs[0],e.inputs[1],i,r,o))},Oc=e=>{Ke(e,"Add",(t,i)=>`${t}+${i}`)},Rc=e=>{Ke(e,"Div",(t,i)=>`${t}/${i}`)},Bc=e=>{Ke(e,"Equal",{scalar:(t,i)=>`u32(${t}==${i})`,vector:(t,i)=>`vec4<u32>(${t}==${i})`},void 0,void 0,9)},Nc=e=>{Ke(e,"Mul",(t,i)=>`${t}*${i}`)},Mc=e=>{let t=N("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Ke(e,"Pow",{scalar:(i,r)=>`pow_custom(${i},${r})`,vector:(i,r)=>`pow_vector_custom(${i},${r})`},`
...
`)},Su=(e,t,i,r)=>{let n=O.size(i),o=new Array(e.length),s=new Array(e.length),l=0,d=[],c=[],g=[{type:12,data:n}];for(let b=0;b<e.length;++b)l+=e[b].dims[t],o[b]=l,c.push(e[b].dims.length),s[b]=N(`input${b}`,r,c[b]),d.push("rank"),g.push({type:12,data:o[b]});for(let b=0;b<e.length;++b)g.push(...Z(e[b].dims));g.push(...Z(i));let m=K("output",r,i.length),y=m.indicesGet("indices",t),w=Array.from(Array(o.length).keys()).map(b=>`uniforms.sizeInConcatAxis${b}`).join(","),_=b=>`
  ...
  ${b.mainStart()}
    ...
    ${xu(s,m)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:i,dataType:r}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:g}),getShaderSource:_}},Vc=(e,t)=>{let i=e.inputs,r=i[0].dims,n=O.normalizeAxis(t.axis,r.length);bu(i,n);let o=r.slice();o[n]=i.reduce((l,d)=>l+(d.dims.length>n?d.dims[n]:0),0);let s=i.filter(l=>O.size(l.dims)>0);e.compute(Su(s,n,o,i[0].dataType),{inputs:s})},Lc=e=>ge({axis:e.axis})}),It,Et,zt,Va,Ot=q(()=>{"use strict";te(),se(),It=(e,t,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${i}(uniforms.clip_min)), ${t}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Et=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},zt=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Va=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[i,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:i,beta:r}}else if(t==="Clip"){let[i,r]=e?.activation_params||[wp,$p];return{activation:t,clipMax:r,clipMin:i}}else if(t==="LeakyRelu"){let[i]=e?.activation_params||[.01];return{activation:t,alpha:i}}return{activation:t}}}),Ce,Gc,La=q(()=>{"use strict";Ce=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Gc=e=>`
      ${e?"value = value + getBiasByOutputCoords(coords);":""}
      `}),Hc,yy=q(()=>{"use strict";Hc=e=>`
...
`}),or,Ga,Ha=q(()=>{"use strict";te(),se(),ue(),Ot(),or=(e,t,i,r,n)=>{let o=r-i;return`
...
`}return de};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${m};${y};${w};${n}`,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:o?o(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:$}),getShaderSource:k}}}),ku,Tu,_a,Bi,Cu,wa,Iu,Gr,Fa=q(()=>{"use strict";te(),se(),ue(),Ot(),Ha(),La(),ku=(e,t)=>e?`
        ...
        }`,_a=(e,t,i="f32",r,n=!1,o=32,s=!1,l=32)=>{let d=t[1]*e[1],c=t[0]*e[0],g=n?d:o,m=n?o:d,y=g/t[0],w=o/t[1];if(!((n&&y===4&&e[1]===4||!n&&(y===3||y===4))&&g%t[0]===0&&o%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${n} is true, innerElementSize ${y} and workPerThread[1] ${e[1]} must be 4.
...
`},Iu=(e,t,i,r,n=!1)=>{let[o,s,l,d]=r,c=Te(r[0].type.tensor);return`
...
`)};
    ...
    ${_}`},g=[{type:12,data:d},...Z(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${s}${l}`,inputDependencies:["rank"]},getShaderSource:c,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:g})}},sh=e=>{Xu(e.inputs),e.compute(Ju(e.inputs),{inputs:[0]})}}),el,oh,Iy=q(()=>{"use strict";te(),se(),ue(),qa(),el=e=>{let t=e[0].dataType,i=O.size(e[0].dims),r=O.size(e[1].dims),n=r%4===0,o=s=>{let l=N("x",t,[1],4),d=N("bias",t,[1],4),c=K("y",t,[1],4),g=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],m=w=>`
  ...
  ${y.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((w,_)=>_!==1).map(w=>w.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(w,_)=>"rank")},getRunData:()=>({outputs:[{dims:l,dataType:c}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:m}),getShaderSource:y}},ch=(e,t)=>{let i=e.inputs;al(i,t),e.compute(nl(e.inputs,t))},hh=e=>ge({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),sl,ol,fh,mh,Oy=q(()=>{"use strict";te(),se(),be(),ue(),sl=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return m?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:c*g},programUniforms:w}),getShaderSource:S}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(y/64)},programUniforms:w}),getShaderSource:b}},gh=e=>{let t=e.transA,i=e.transB,r=e.alpha,n=e.beta;return{transA:t,transB:i,alpha:r,beta:n,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},yh=(e,t)=>{ul(e.inputs),e.compute(ll(e.inputs,t))}}),et,ot,bt,vt,dl,pl,cl,hl,fl,ml,gl,yl,_h,wh,By=q(()=>{"use strict";te(),se(),be(),ue(),[et,ot,bt,vt]=[0,1,2,3],dl=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},pl=`
...
`)}
  ...
  ${I.mainStart()}
    ...
    `,l="",d=N("x",t.dataType,t.dims.length),c=["rank"],[g,m,y,w,_]=ji(o,n);return g.push(...Z(t.dims,o)),{name:e,shaderCache:{hint:`${r.cacheKey};${y};${w};${_}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:o,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(O.size(o)/64)},programUniforms:g}),getShaderSource:b=>Ki(b,d,t.dims.length,o.length,n,s,l,t.dataType===10?-65504:-1e5,m,y,w,_)}},Dh=(e,t)=>{Jt(e.inputs),e.compute(Ji("MaxPool",e.inputs[0],!1,t))},Ph=e=>{let t=e.storage_order,i=e.dilations,r=Zi(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let n=qe(Re({storageOrder:t,dilations:i},r),{cacheKey:""});return qe(Re({},n),{cacheKey:Ll(n)})},Uh=e=>{let t=e.format;return qe(Re({format:t},Yi),{cacheKey:t})},Wh=(e,t)=>{Jt(e.inputs),e.compute(Ji("GlobalMaxPool",e.inputs[0],!0,t))}}),Gl,Hl,qh,Vh,Vy=q(()=>{"use strict";te(),se(),be(),ue(),Gl=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((i,r)=>i===e[2].dims[r]).reduce((i,r)=>i&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((n,o)=>o===t.axis||n===e[0].dims[o]).reduce((n,o)=>n&&o,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(i/r)||t.blockSize>Math.ceil(i/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Hl=(e,t)=>{let i=O.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,n=r===3,o=e[0].dims,s=e[1].dataType,l=O.size(o),d=r===3||r===2,c=d?[Math.ceil(O.size(e[0].dims)/4)]:e[0].dims,g=e[1].dims,m=e.length>2?e[2]:void 0,y=m?d?[Math.ceil(O.size(m.dims)/4)]:m.dims:void 0,w=g.length===0||g.length===1&&g[0]===1,_=w===!1&&g.length===1,b=$e(l),S=w&&(!d||b===4),v=S?b:1,$=S&&!d?b:1,k=N("input",d?12:r,c.length,$),C=N("scale",s,g.length),I=m?N("zero_point",d?12:r,y.length):void 0,E=K("output",s,o.length,v),A=[k,C];I&&A.push(I);let D=[c,g];m&&D.push(y);let V=[{type:12,data:l/v},{type:12,data:i},{type:12,data:t.blockSize},...Z(...D,o)],H=X=>{let ee=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:I?["rank","rank","rank"]:["rank","rank"]},getShaderSource:H,getRunData:()=>({outputs:[{dims:o,dataType:s}],dispatchGroup:{x:Math.ceil(l/v/64),y:1,z:1},programUniforms:V})}},qh=(e,t)=>{Gl(e.inputs,t),e.compute(Hl(e.inputs,t))},Vh=e=>ge({axis:e.axis,blockSize:e.blockSize})}),Fl,jl,Lh,Ly=q(()=>{"use strict";Ze(),te(),ue(),Fl=(e,t,i)=>{let r=e===t,n=e<t&&i<0,o=e>t&&i>0;if(r||n||o)throw new Error("Range these inputs' contents are invalid.")},jl=(e,t,i,r)=>{let n=Math.abs(Math.ceil((t-e)/i)),o=[n],s=n,l=[{type:12,data:s},{type:r,data:e},{type:r,data:i},...Z(o)],d=c=>{let g=K("output",r,o.length),m=g.type.value,y=[{name:"outputSize",type:"u32"},{name:"start",type:m},{name:"delta",type:m}];return`
        ${c.registerUniforms(y).declareVariables(g)}
        ${c.mainStart()}
        ${c.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${m}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:d,getRunData:()=>({outputs:[{dims:o,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:l})}},Lh=e=>{let t=0,i=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],i=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],i=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),we.webgpu.validateInputContent&&Fl(t,i,r),e.compute(jl(t,i,r,e.inputs[0].dataType),{inputs:[]})}}),Kl,Ql,Gh,Hh,Gy=q(()=>{"use strict";te(),se(),be(),ue(),Kl=(e,t,i,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let n=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,o=`;
...
`:"",od=(e,t,i,r,n)=>{let[o,s,l,d]=i.length===2?[-1,0,1,-1]:[0,2,3,1],c=e.type.value;return`
    ...
    }`},ud=(e,t,i,r,n,o,s,l,d,c)=>{let g=i.length===2,m=!0,[y,w]=g?[0,1]:m?[2,3]:[1,2],_=e.type.value,b=S=>{let v=S===y?"row":"col";return`
