import {aV as kc,aW as mo,dp as So,aX as y0,T,cc as be,aA as o0,aK as Dr,bd as Sw,ds as or,cb as $e,r as rw,bL as P$1,cd as ue,cA as Io,dt as c0,a as gE,b1 as a0,a_ as s0,bJ as iD,bK as sD,E as pi,a8 as Fp,M as Fc,H as jE,R as Lv,V as VE,Z as Lp,a$ as ph,b0 as S,ay as wD,X as Xp,b2 as zp,b3 as cD,b4 as lD,b8 as Gp,b9 as pe$1,h as hn,n as ne,cf as EI,aM as Cp,c9 as J,U as Up,a5 as Pc,du as Y,cW as Yf,a3 as rD,cw as go,K as kD,Y as sh,a6 as $E,bC as HE,a7 as UE,aO as Jp}from'./main-ZDHV7TIP.js';var vt=["knob"],gt=["valueIndicatorContainer"];function bt(s,c){if(s&1&&(pi(0,"div",2,1)(2,"div",5)(3,"span",6),kD(4),Fc()()()),s&2){let t=rD();Lv(4),sh(t.valueIndicatorText);}}var Tt=["trackActive"],kt=["*"];function It(s,c){if(s&1&&Fp(0,"div"),s&2){let t=c.$implicit,i=c.$index,e=rD(3);wD(t===0?"mdc-slider__tick-mark--active":"mdc-slider__tick-mark--inactive"),Jp("transform",e._calcTickMarkTransform(i));}}function Rt(s,c){if(s&1&&$E(0,It,1,4,"div",8,HE),s&2){let t=rD(2);UE(t._tickMarks);}}function xt(s,c){if(s&1&&(pi(0,"div",6,1),jE(2,Rt,2,0),Fc()),s&2){let t=rD();Lv(2),VE(t._cachedWidth?2:-1);}}function yt(s,c){if(s&1&&Fp(0,"mat-slider-visual-thumb",7),s&2){let t=rD();Lp("discrete",t.discrete)("thumbPosition",1)("valueIndicatorText",t.startValueIndicatorText);}}var n=(function(s){return s[s.START=1]="START",s[s.END=2]="END",s})(n||{}),f=(function(s){return s[s.ACTIVE=0]="ACTIVE",s[s.INACTIVE=1]="INACTIVE",s})(f||{}),P=new S("_MatSlider"),ct=new S("_MatSliderThumb"),Mt=new S("_MatSliderRangeThumb"),mt=new S("_MatSliderVisualThumb");var St=(()=>{class s{_cdr=T(o0);_ngZone=T(be);_slider=T(P);_renderer=T(EI);_listenerCleanups;discrete=false;thumbPosition;valueIndicatorText;_ripple;_knob;_valueIndicatorContainer;_sliderInput;_sliderInputEl;_hoverRippleRef;_focusRippleRef;_activeRippleRef;_isHovered=false;_isActive=false;_isValueIndicatorVisible=false;_hostElement=T(Dr).nativeElement;_platform=T(P$1);ngAfterViewInit(){let t=this._slider._getInput(this.thumbPosition);t&&(this._ripple.radius=24,this._sliderInput=t,this._sliderInputEl=this._sliderInput._hostElement,this._ngZone.runOutsideAngular(()=>{let i=this._sliderInputEl,e=this._renderer;this._listenerCleanups=[e.listen(i,"pointermove",this._onPointerMove),e.listen(i,"pointerdown",this._onDragStart),e.listen(i,"pointerup",this._onDragEnd),e.listen(i,"pointerleave",this._onMouseLeave),e.listen(i,"focus",this._onFocus),e.listen(i,"blur",this._onBlur)];}));}ngOnDestroy(){this._listenerCleanups?.forEach(t=>t());}_onPointerMove=t=>{if(this._sliderInput._isFocused)return;let i=this._hostElement.getBoundingClientRect(),e=this._slider._isCursorOnSliderThumb(t,i);this._isHovered=e,e?this._showHoverRipple():this._hideRipple(this._hoverRippleRef);};_onMouseLeave=()=>{this._isHovered=false,this._hideRipple(this._hoverRippleRef);};_onFocus=()=>{this._hideRipple(this._hoverRippleRef),this._showFocusRipple(),this._hostElement.classList.add("mdc-slider__thumb--focused");};_onBlur=()=>{this._isActive||this._hideRipple(this._focusRippleRef),this._isHovered&&this._showHoverRipple(),this._hostElement.classList.remove("mdc-slider__thumb--focused");};_onDragStart=t=>{t.button===0&&(this._isActive=true,this._showActiveRipple());};_onDragEnd=()=>{this._isActive=false,this._hideRipple(this._activeRippleRef),this._sliderInput._isFocused||this._hideRipple(this._focusRippleRef),this._platform.SAFARI&&this._showHoverRipple();};_showHoverRipple(){this._isShowingRipple(this._hoverRippleRef)||(this._hoverRippleRef=this._showRipple({enterDuration:0,exitDuration:0}),this._hoverRippleRef?.element.classList.add("mat-mdc-slider-hover-ripple"));}_showFocusRipple(){this._isShowingRipple(this._focusRippleRef)||(this._focusRippleRef=this._showRipple({enterDuration:0,exitDuration:0},true),this._focusRippleRef?.element.classList.add("mat-mdc-slider-focus-ripple"));}_showActiveRipple(){this._isShowingRipple(this._activeRippleRef)||(this._activeRippleRef=this._showRipple({enterDuration:225,exitDuration:400}),this._activeRippleRef?.element.classList.add("mat-mdc-slider-active-ripple"));}_isShowingRipple(t){return t?.state===Y.FADING_IN||t?.state===Y.VISIBLE}_showRipple(t,i){if(!this._slider.disabled&&(this._showValueIndicator(),this._slider._isRange&&this._slider._getThumb(this.thumbPosition===n.START?n.END:n.START)._showValueIndicator(),!(this._slider._globalRippleOptions?.disabled&&!i)))return this._ripple.launch({animation:this._slider._noopAnimations?{enterDuration:0,exitDuration:0}:t,centered:true,persistent:true})}_hideRipple(t){if(t?.fadeOut(),this._isShowingAnyRipple())return;this._slider._isRange||this._hideValueIndicator();let i=this._getSibling();i._isShowingAnyRipple()||(this._hideValueIndicator(),i._hideValueIndicator());}_showValueIndicator(){this._hostElement.classList.add("mdc-slider__thumb--with-indicator");}_hideValueIndicator(){this._hostElement.classList.remove("mdc-slider__thumb--with-indicator");}_getSibling(){return this._slider._getThumb(this.thumbPosition===n.START?n.END:n.START)}_getValueIndicatorContainer(){return this._valueIndicatorContainer?.nativeElement}_getKnob(){return this._knob.nativeElement}_isShowingAnyRipple(){return this._isShowingRipple(this._hoverRippleRef)||this._isShowingRipple(this._focusRippleRef)||this._isShowingRipple(this._activeRippleRef)}static \u0275fac=function(i){return new(i||s)};static \u0275cmp=gE({type:s,selectors:[["mat-slider-visual-thumb"]],viewQuery:function(i,e){if(i&1&&zp(Yf,5)(vt,5)(gt,5),i&2){let a;cD(a=lD())&&(e._ripple=a.first),cD(a=lD())&&(e._knob=a.first),cD(a=lD())&&(e._valueIndicatorContainer=a.first);}},hostAttrs:[1,"mdc-slider__thumb","mat-mdc-slider-visual-thumb"],inputs:{discrete:"discrete",thumbPosition:"thumbPosition",valueIndicatorText:"valueIndicatorText"},features:[ph([{provide:mt,useExisting:s}])],decls:4,vars:2,consts:[["knob",""],["valueIndicatorContainer",""],[1,"mdc-slider__value-indicator-container"],[1,"mdc-slider__thumb-knob"],["matRipple","",1,"mat-focus-indicator",3,"matRippleDisabled"],[1,"mdc-slider__value-indicator"],[1,"mdc-slider__value-indicator-text"]],template:function(i,e){i&1&&(jE(0,bt,5,1,"div",2),Fp(1,"div",3,0)(3,"div",4)),i&2&&(VE(e.discrete?0:-1),Lv(3),Lp("matRippleDisabled",true));},dependencies:[Yf],styles:[`.mat-mdc-slider-visual-thumb .mat-ripple {
  height: 100%;
  width: 100%;
}
