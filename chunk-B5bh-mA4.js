  ...
  <div class="user-guide-section">
    ...
    <div class="flex-column" style="gap: 1.75rem;">
      ...
      <div class="guide-step" style="border-left: 3px solid #0b6b5f; padding-left: 1.25rem;">
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem; margin-top: 1rem;">
          ...
          <div style="background: var(--bg-overlay, rgba(255,255,255,0.03)); border: 1px solid var(--glass-border); border-radius: var(--radius-md, 8px); padding: 1rem;">
            ...
            <ul class="body-text" style="padding-left: 1.25rem; margin: 0; display: flex; flex-direction: column; gap: 0.35rem;">
              <li>Filter by department <span class="material-icons help-inline-icon">category</span> (Hematology, Biochemistry, Serology, etc.) and select any test panel.</li>
              ...
              <li><strong>Custom Price List:</strong> Set your clinic's billing price in \u20B9 for each investigation package. These prices automatically populate invoices and receipts.</li>
            </ul>
          </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem; margin-top: 1rem;">
          ...
          <div style="background: var(--bg-overlay, rgba(255,255,255,0.03)); border: 1px solid var(--glass-border); border-radius: var(--radius-md, 8px); padding: 1rem;">
            ...
            <ul class="body-text" style="padding-left: 1.25rem; margin: 0; display: flex; flex-direction: column; gap: 0.35rem;">
              ...
              <li><strong>Collection & Reporting Dates:</strong> <span class="material-icons help-inline-icon">calendar_today</span> Specify specimen collection timestamp and report release timestamp. Defaults to the current date and time.</li>
      ...
      <div class="guide-step" style="border-left: 3px solid #3b82f6; padding-left: 1.25rem;">
        <h3 class="subsection-title" style="display: flex; align-items: center; gap: 0.5rem; color: var(--text-primary);">
          <span class="material-icons" style="font-size: 22px; color: #3b82f6;">science</span> 3. Test Catalog Selection & Diagnostic Panels
        </h3>
        <p class="body-text">
          Select individual diagnostic investigations or comprehensive multi-analyte clinical profiles in seconds:
        </p>
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem; margin-top: 1rem;">
          <div style="background: var(--bg-overlay, rgba(255,255,255,0.03)); border: 1px solid var(--glass-border); border-radius: var(--radius-md, 8px); padding: 1rem;">
            ...
            <p class="body-text" style="margin: 0;">
              Press <kbd style="background: var(--bg-overlay); border: 1px solid var(--glass-border); border-radius: 4px; padding: 2px 6px;">/</kbd> anywhere on your keyboard. Focus instantly jumps to the <span class="material-icons help-inline-icon">search</span> test search input. Type either a panel acronym (e.g. <em>CBC</em>, <em>LFT</em>, <em>KFT</em>, <em>Lipid</em>, <em>Thyroid</em>, <em>Widal</em>, <em>HbA1c</em>) or a specific analyte name (e.g. <em>Creatinine</em>, <em>Bilirubin</em>, <em>Platelet</em>, <em>SGPT</em>, <em>Uric Acid</em>). Click to add.
            </p>
          </div>

          <div style="background: var(--bg-overlay, rgba(255,255,255,0.03)); border: 1px solid var(--glass-border); border-radius: var(--radius-md, 8px); padding: 1rem;">
            <strong style="color: var(--text-primary); display: block; margin-bottom: 0.35rem;">Method B: Department Category Filter Chips</strong>
            <p class="body-text" style="margin: 0;">
              Click any department chip above the catalog: <span class="material-icons help-inline-icon">category</span> <strong>All</strong>, <strong>Hematology</strong>, <strong>Biochemistry</strong>, <strong>Serology</strong>, <strong>Clinical Pathology</strong>, or <strong>Diabetology</strong>. The list filters instantly to show all available packages in that domain.
            </p>
          </div>

          <div style="background: var(--bg-overlay, rgba(255,255,255,0.03)); border: 1px solid var(--glass-border); border-radius: var(--radius-md, 8px); padding: 1rem;">
            <strong style="color: var(--text-primary); display: block; margin-bottom: 0.35rem;">Managing Selected Investigations</strong>
            <ul class="body-text" style="padding-left: 1.25rem; margin: 0; display: flex; flex-direction: column; gap: 0.35rem;">
              <li><strong>Multi-Panel Stacking:</strong> Select multiple panels simultaneously (e.g. <em>Complete Blood Count</em> + <em>Liver Function Test</em> + <em>Lipid Profile</em>). They stack cleanly in the report in optimal clinical order.</li>
              <li><strong>Removing a Test:</strong> Click the <span class="material-icons help-inline-icon">close</span> delete chip on any selected panel to remove it from the active report.</li>
              <li><strong>Active Tally:</strong> The top ribbon displays your active load: e.g. <span class="help-icon-chip"><span class="material-icons">science</span> 3 Tests (38 params)</span> alongside total fee estimates.</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="guide-step" style="border-left: 3px solid #8b5cf6; padding-left: 1.25rem;">
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem; margin-top: 1rem;">
          <div style="background: var(--bg-overlay, rgba(255,255,255,0.03)); border: 1px solid var(--glass-border); border-radius: var(--radius-md, 8px); padding: 1rem;">
            <strong style="color: var(--text-primary); display: block; margin-bottom: 0.35rem;">1. Directional Arrow & Enter Traversal</strong>
            <p class="body-text" style="margin: 0;">
          ...
          <div style="background: var(--bg-overlay, rgba(255,255,255,0.03)); border: 1px solid var(--glass-border); border-radius: var(--radius-md, 8px); padding: 1rem;">
            <strong style="color: var(--text-primary); display: block; margin-bottom: 0.35rem;">2. Qualitative Rapid Keys (<kbd>N</kbd> / <kbd>P</kbd>)</strong>
            <p class="body-text" style="margin: 0;">
              When navigating qualitative dropdowns (Urine Albumin, Sugar, Ketones, Bile Salts, Widal Test, HBsAg, HIV, VDRL, Dengue NS1):
              simply press <kbd>N</kbd> on your keyboard for <strong>Negative / Non-Reactive</strong>, or press <kbd>P</kbd> for <strong>Positive / Reactive</strong>. No mouse clicks required!
            </p>
          </div>

          <div style="background: var(--bg-overlay, rgba(255,255,255,0.03)); border: 1px solid var(--glass-border); border-radius: var(--radius-md, 8px); padding: 1rem;">
            <strong style="color: var(--text-primary); display: block; margin-bottom: 0.35rem;">3. One-Click Baseline Pre-Fill ("Fill Normal Values")</strong>
            <p class="body-text" style="margin: 0;">
          ...
          <div style="background: var(--bg-overlay, rgba(255,255,255,0.03)); border: 1px solid var(--glass-border); border-radius: var(--radius-md, 8px); padding: 1rem;">
            <strong style="color: var(--text-primary); display: block; margin-bottom: 0.35rem;">4. Real-Time Out-of-Bounds & Critical Panic Alerts</strong>
            <ul class="body-text" style="padding-left: 1.25rem; margin: 0; display: flex; flex-direction: column; gap: 0.35rem;">
          ...
          <div style="background: var(--bg-overlay, rgba(255,255,255,0.03)); border: 1px solid var(--glass-border); border-radius: var(--radius-md, 8px); padding: 1rem;">
            <strong style="color: var(--text-primary); display: block; margin-bottom: 0.35rem;">5. Automated Medical Calculation Engine & Overrides</strong>
            <p class="body-text" style="margin: 0 0 0.5rem 0;">
    ...
    <div style="overflow-x: auto; background: var(--bg-overlay, rgba(255,255,255,0.04)); border: 1px solid var(--glass-border); border-radius: var(--radius-md, 8px);">
      <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 13px;">
        ...
        <tbody>
          ...
          <tr>
            <td style="padding: 8px 16px;"><kbd>?</kbd></td>
            <td style="padding: 8px 16px;">Toggle interactive keyboard shortcuts dialog</td>
            <td style="padding: 8px 16px; color: var(--text-secondary);">Global Studio (<span class="material-icons help-inline-icon">keyboard</span>)</td>
          </tr>
        </tbody>
      </table>
    </div>
...
`,w={"pathology-lab":x,wordart:f,"embroidery-digitizer":e,"background-remover":t,"png-to-svg-potrace":i,"png-to-svg":c,"webgl-json-viewer":a,"meme-generator":s,"rich-text-lab":o,"svg-sticker-effect":r,"rent-receipt":n,"ppf-calculator":l,"aspect-ratio-demo":d,"loan-projector":p,"json-viewer":g,"json-viewer-highperf":h,halftone:m,"color-picker-demo":u,"json-compare":y,"text-whitespace-remover":b,"screen-recorder":v};export{w};