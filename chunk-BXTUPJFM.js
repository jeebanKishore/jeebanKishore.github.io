import{a as V,b as F,c as W,d as N,i as re,j as he}from"./chunk-3L63MYKR.js";import{a as de,b as ge,c as pe,d as me}from"./chunk-ZSCNHLZL.js";import{a as K,b as oe,c as ae,d as ie}from"./chunk-ONJT3MGW.js";import"./chunk-HD3VZZTZ.js";import{a as U,b as B,c as H,e as J,f as q}from"./chunk-DZL2HPZF.js";import{a as se,b as ce,c as le}from"./chunk-Q4YRH3MP.js";import"./chunk-GJTHFYAL.js";import"./chunk-SNXVZCAO.js";import"./chunk-U4U3MCI2.js";import"./chunk-ZOA7PFM3.js";import{a as Y,b as Z,d as $,i as ee,n as te,u as ne}from"./chunk-QIZVHMJJ.js";import{l as L,na as Q,qa as X}from"./chunk-MAIIBS6V.js";import"./chunk-IYG2E4GL.js";import{A as j,Bb as D,Cb as P,Db as O,Dc as k,Eb as f,Fb as o,Gb as i,Hb as R,Ob as v,R as A,Tb as m,Vb as l,Xa as s,ba as I,dc as w,e as T,eb as M,fc as C,ga as h,ha as u,hc as c,ic as y,jc as G,kb as E,oa as z,sa as b,xb as x,yb as g,zb as p}from"./chunk-QZ6JFUTB.js";import"./chunk-HZ6M6AS2.js";var ue=b([{id:"calculator",name:"Calculator",description:"A functional calculator built with Angular Signals for reactive state management. Features basic arithmetic operations with a clean Material Design interface.",icon:"calculate",route:"calculator",live:!1,technologies:["Angular","Signals","Material Design"]},{id:"todo",name:"Todo App",description:"Task management application demonstrating Material Design components and signal-based state. Includes filtering, completion tracking, and persistent storage.",icon:"checklist",route:"todo",live:!1,technologies:["Angular","Signals","Material Design","Local Storage"]},{id:"dashboard-analytics",name:"Analytics Dashboard",description:"Interactive data visualization dashboard showcasing charts, metrics, and real-time updates using Angular and chart libraries.",icon:"dashboard",route:"dashboard-analytics",live:!1,technologies:["Angular","Chart.js","Material Design","RxJS"]},{id:"json-viewer",name:"Json Viewer",description:"It formats the JSON in to a tree view to inspect for data and key values using angular mat-tree",icon:"code",route:"json-viewer",live:!0,technologies:["Angular","Angular material","JSON"]},{id:"json-viewer-highperf",name:"JSON Viewer High Performance",description:"JsonVIewer high performance tree flatner",icon:"file",route:"json-viewer-highperf",live:!0,technologies:["Angular","mat tree"]},{id:"webgl-json-viewer",name:"WebGL JSON Viewer",description:"Advanced JSON visualization tool capable of handling 20MB+ datasets using WebGL rendering and WebAssembly parsing for smooth 60fps performance.",icon:"speed",route:"webgl-json-viewer",live:!0,technologies:["Angular","WebGL","WebAssembly","Rust","Signals"]},{id:"loan-projector",name:"Precision Loan Projector",description:"Advanced financial tool simulating daily reducing balance loans with support for multiple irregular interest rate revisions and interactive visualization.",icon:"trending_down",route:"loan-projector",live:!0,technologies:["Angular","Signals","Chart.js","Financial Math"]},{id:"ppf-calculator",name:"Precision PPF Calculator",description:"Advanced financial tool simulating daily reducing balance loans with support for multiple irregular interest rate revisions and interactive visualization.",icon:"trending_down",route:"ppf-calculator",live:!0,technologies:["Angular","Signals","Chart.js","Financial Math"]},{id:"rent-receipt",name:"Rent Receipt Generator",description:"Professional rent receipt generator with automated monthly breakdown, Indian currency number-to-words logic, and professional PDF layout.",icon:"receipt_long",route:"rent-receipt",live:!0,technologies:["Angular","Signals","Native Print Engine","Financial Math"]},{id:"png-to-svg",name:"High Fidelity Raster to Vector",description:"Converts raster images (PNG/JPG) to scalable SVG vectors using a Rust-based Wasm engine. Features clustering, spline fitting, and layer stacking.",icon:"polyline",route:"png-to-svg",live:!0,technologies:["Angular","Rust","WebAssembly","Signals"]},{id:"aspect-ratio-demo",name:"Dynamic Aspect Ratio Fitting",description:"Interactive demonstration of preserveAspectRatio behavior for Canvas and SVG elements with meet/slice modes and alignment controls.",icon:"aspect_ratio",route:"aspect-ratio-demo",live:!0,technologies:["Angular","Canvas API","SVG","Signals"]},{id:"svg-sticker-effect",name:"SVG Sticker Effect Generator",description:"Professional sticker effect generator with customizable white outlines, cutting path generation, and multiple export formats for print and cutting applications.",icon:"auto_fix_high",route:"svg-sticker-effect",live:!0,technologies:["Angular","SVG Filters","Signals","File Processing"]},{id:"meme-generator",name:"Meme Generator",description:"Create custom memes with text overlay and image manipulation",route:"meme-generator",icon:"auto_fix_high",live:!0,technologies:["Angular","Signals","Canvas API","File Upload","Glass UI"]},{icon:"auto_fix_high",id:"embroidery-digitizer",name:"Embroidery Digitizer",description:"Convert images to embroidery files with thread cost analysis",route:"embroidery-digitizer",live:!0,technologies:["Angular","WASM","OpenCV","Canvas API"]},{id:"png-to-svg-potrace",name:"High-Fidelity Raster to Vector Using Potrace",description:"Converts raster images (PNG/JPG) to scalable SVG vectors using a Rust-based Wasm engine. Features clustering, spline fitting, and layer stacking.",icon:"polyline",route:"png-to-svg-potrace",live:!0,technologies:["Angular","Rust","WebAssembly","Signals"]},{id:"background-remover",name:"Magic Background Remover",description:"Zero-click background removal showcasing two distinct architectures: a high-performance Rust/WASM Neural Network (U^2-Net) and an algorithmic OpenCV GrabCut approach.",icon:"wallpaper",route:"background-remover",live:!0,technologies:["Angular","Rust","WebAssembly","OpenCV","Canvas API","Signals"]},{id:"rich-text-lab",name:"Rich Text Editor Lab",description:"WYSIWYG contenteditable editor + IME + paste cleanup + base64 image paste + export staging.",icon:"edit",route:"rich-text-lab",live:!0,technologies:["Angular 21","Signals","Zoneless","Angular Material 21","ContentEditable","IME"]}]),_=b(null);var ye=`
